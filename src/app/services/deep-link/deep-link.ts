...
export class DeepLinkProvider {
  ...
  showDeeplinkOnlyOnDevicesAlert() {
    this.translateService
      .get([
        "deep-link.not-supported-alert.title",
        "deep-link.not-supported-alert.message",
  ...
  showAppNotFoundAlert() {
    this.translateService
      .get(
        [
          "deep-link.app-not-found.title",
          "deep-link.app-not-found.message",
          "deep-link.app-not-found.ok"
        ],
        {
